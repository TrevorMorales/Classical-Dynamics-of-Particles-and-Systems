...
plt.figtext(0.55, 0.7, 'For t = ' + str(round(Time[Steps-1])) + ' a = ' + str(round(Acceleration[Steps-1],3)))
...
plt.figtext(0.55, 0.25, 'For t = ' + str(round(Time[Steps-1])) + ' v = ' + str(round(Velocity[Steps-1],3)))
...
plt.figtext(0.55, 0.25, 'For t = ' + str(round(Time[Steps-1])) + ' v = ' + str(round(Position[Steps-1],3)))
